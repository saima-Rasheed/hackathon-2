  ...
  return (
    <div>
      <div className='flex flex-col justify-center items-center text-2xl font-bold '>
            ...
            <input type='checkbox'id='keepMeSignIn' className='h-4 w-4  text-gray-500'/> <div className='text-large'> keep me signed in </div></div><div className='flex-col justify-center items-center ml-56  mt-5 md:ml-72 lg:ml-72'> Forgotten your password? </div>
